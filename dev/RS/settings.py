...
DATABASES = {
    ...
    'stores_data': {
        ...
        'NAME': os.getenv('CASSANDRA_KEYSPACE_NAME'),
        'TEST_NAME': os.getenv('CASSANDRA_TEST_NAME'),
        'HOST': os.getenv('CASSANDRA_DB_HOST'),
        'USER': os.getenv('CASSANDRA_DB_USER'),
        'PASSWORD': os.getenv('CASSANDRA_DB_PASSWORD'),
        'OPTIONS': {
            'replication': {
                'strategy_class': 'SimpleStrategy', # Since on same machine
